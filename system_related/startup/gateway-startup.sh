...
APPLY_RESULT_FILE="${NETWORK_DIR}/apply-result.json"
BOOT_FAIL_COUNT_FILE="${NETWORK_DIR}/startup-boot-fail-count"
RECOVERY_STATE_FILE="${NETWORK_DIR}/startup-recovery-state.json"
SAFE_MODE_FILE="${NETWORK_DIR}/startup-safe-mode-active"
...
date --iso-8601=seconds > "${NETWORK_DIR}/last-boot.txt"
touch "${NETWORK_DIR}/startup-ran"
